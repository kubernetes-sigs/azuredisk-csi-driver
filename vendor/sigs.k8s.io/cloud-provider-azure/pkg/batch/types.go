...
// BatchFunc is the function that processes a batch of values and return results.
//
...
type BatchFunc func(ctx context.Context, key string, values []interface{}) ([]interface{}, error)
