...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.31.10/deploy/install-driver.sh | bash -s v1.31.10 snapshot --
```
...
git checkout v1.31.10
./deploy/install-driver.sh v1.31.10 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.31.10/deploy/uninstall-driver.sh | bash -s v1.31.10 --
```
...
cd azuredisk-csi-driver
git checkout v1.31.10
./deploy/uninstall-driver.sh v1.31.10 local
```
