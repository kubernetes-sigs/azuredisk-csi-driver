...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.2/deploy/install-driver.sh | bash -s v1.33.2 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.2/deploy/uninstall-driver.sh | bash -s v1.33.2 --
```
