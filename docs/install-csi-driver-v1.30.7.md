...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.30.7/deploy/install-driver.sh | bash -s v1.30.7 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.30.7/deploy/uninstall-driver.sh | bash -s v1.30.7 --
```
...
cd azuredisk-csi-driver
git checkout v1.30.7
./deploy/uninstall-driver.sh v1.30.7 local
```
