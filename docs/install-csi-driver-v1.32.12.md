...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.12/deploy/install-driver.sh | bash -s v1.32.12 snapshot --
```
...
git checkout v1.32.12
./deploy/install-driver.sh v1.32.12 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.12/deploy/uninstall-driver.sh | bash -s v1.32.12 --
```
