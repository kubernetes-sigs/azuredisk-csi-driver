...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.28.11/deploy/install-driver.sh | bash -s v1.28.11 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.28.11/deploy/uninstall-driver.sh | bash -s v1.28.11 --
```
...
cd azuredisk-csi-driver
git checkout v1.28.11
./deploy/uninstall-driver.sh v1.28.11 local
```
