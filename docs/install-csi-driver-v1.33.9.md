...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.9/deploy/install-driver.sh | bash -s v1.33.9 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.9/deploy/uninstall-driver.sh | bash -s v1.33.9 --
```
