...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.28.3/deploy/install-driver.sh | bash -s v1.28.3 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.28.3/deploy/uninstall-driver.sh | bash -s v1.28.3 --
```
...
cd azuredisk-csi-driver
git checkout v1.28.3
./deploy/uninstall-driver.sh v1.28.3 local
```
