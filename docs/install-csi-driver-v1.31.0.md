...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.31.0/deploy/install-driver.sh | bash -s v1.31.0 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.31.0/deploy/uninstall-driver.sh | bash -s v1.31.0 --
```
...
cd azuredisk-csi-driver
git checkout v1.31.0
./deploy/uninstall-driver.sh v1.31.0 local
```
