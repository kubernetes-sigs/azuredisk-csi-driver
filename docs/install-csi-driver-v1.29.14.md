...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.29.14/deploy/install-driver.sh | bash -s v1.29.14 snapshot --
```
...
git checkout v1.29.14
./deploy/install-driver.sh v1.29.14 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.29.14/deploy/uninstall-driver.sh | bash -s v1.29.14 --
```
