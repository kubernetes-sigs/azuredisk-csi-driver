...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.28.10/deploy/install-driver.sh | bash -s v1.28.10 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.28.10/deploy/uninstall-driver.sh | bash -s v1.28.10 --
```
...
cd azuredisk-csi-driver
git checkout v1.28.10
./deploy/uninstall-driver.sh v1.28.10 local
```
