...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.10/deploy/install-driver.sh | bash -s v1.32.10 snapshot --
```
...
git checkout v1.32.10
./deploy/install-driver.sh v1.32.10 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.10/deploy/uninstall-driver.sh | bash -s v1.32.10 --
```
