...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.29.13/deploy/install-driver.sh | bash -s v1.29.13 snapshot --
```
...
git checkout v1.29.13
./deploy/install-driver.sh v1.29.13 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.29.13/deploy/uninstall-driver.sh | bash -s v1.29.13 --
```
