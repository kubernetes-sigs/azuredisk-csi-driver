...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.13/deploy/install-driver.sh | bash -s v1.33.13 snapshot --
```
...
git checkout v1.33.13
./deploy/install-driver.sh v1.33.13 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.13/deploy/uninstall-driver.sh | bash -s v1.33.13 --
```
...
cd azuredisk-csi-driver
git checkout v1.33.13
./deploy/uninstall-driver.sh v1.33.13 local
```
