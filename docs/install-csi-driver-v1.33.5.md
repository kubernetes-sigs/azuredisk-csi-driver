...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.5/deploy/install-driver.sh | bash -s v1.33.5 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.5/deploy/uninstall-driver.sh | bash -s v1.33.5 --
```
