...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.30.6/deploy/install-driver.sh | bash -s v1.30.6 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.30.6/deploy/uninstall-driver.sh | bash -s v1.30.6 --
```
...
cd azuredisk-csi-driver
git checkout v1.30.6
./deploy/uninstall-driver.sh v1.30.6 local
```
