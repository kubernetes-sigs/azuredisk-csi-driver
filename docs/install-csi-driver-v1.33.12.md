...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.12/deploy/install-driver.sh | bash -s v1.33.12 snapshot --
```
...
./deploy/install-driver.sh v1.33.12 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.33.12/deploy/uninstall-driver.sh | bash -s v1.33.12 --
```
...
cd azuredisk-csi-driver
git checkout v1.33.12
./deploy/uninstall-driver.sh v1.33.12 local
```
