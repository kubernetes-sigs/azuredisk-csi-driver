...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.29.8/deploy/install-driver.sh | bash -s v1.29.8 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.29.8/deploy/uninstall-driver.sh | bash -s v1.29.8 --
```
...
cd azuredisk-csi-driver
git checkout v1.29.8
./deploy/uninstall-driver.sh v1.29.8 local
```
