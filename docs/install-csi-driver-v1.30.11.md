...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.30.11/deploy/install-driver.sh | bash -s v1.30.11 snapshot --
```
...
./deploy/install-driver.sh v1.30.11 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.30.11/deploy/uninstall-driver.sh | bash -s v1.30.11 --
```
