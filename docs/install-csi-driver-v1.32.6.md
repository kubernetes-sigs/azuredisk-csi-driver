...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.6/deploy/install-driver.sh | bash -s v1.32.6 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.6/deploy/uninstall-driver.sh | bash -s v1.32.6 --
```
