...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.26.4/deploy/install-driver.sh | bash -s v1.26.4 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.26.4/deploy/uninstall-driver.sh | bash -s v1.26.4 --
```
