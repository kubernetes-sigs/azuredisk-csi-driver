...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.31.11/deploy/install-driver.sh | bash -s v1.31.11 snapshot --
```
...
git checkout v1.31.11
./deploy/install-driver.sh v1.31.11 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.31.11/deploy/uninstall-driver.sh | bash -s v1.31.11 --
```
