...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.34.7/deploy/install-driver.sh | bash -s v1.34.7 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.34.7/deploy/uninstall-driver.sh | bash -s v1.34.7 --
```
