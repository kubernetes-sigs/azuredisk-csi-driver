...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.11/deploy/install-driver.sh | bash -s v1.32.11 snapshot --
```
...
./deploy/install-driver.sh v1.32.11 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.32.11/deploy/uninstall-driver.sh | bash -s v1.32.11 --
```
