...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.13.0/deploy/install-driver.sh | bash -s v1.13.0 snapshot --
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.13.0/deploy/uninstall-driver.sh | bash -s v1.13.0 --
```
