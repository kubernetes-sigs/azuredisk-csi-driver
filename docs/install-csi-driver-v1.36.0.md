...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.36.0/deploy/install-driver.sh | bash -s v1.36.0 snapshot --
```
...
./deploy/install-driver.sh v1.36.0 local
```
...
```console
curl -skSL https://raw.githubusercontent.com/kubernetes-sigs/azuredisk-csi-driver/v1.36.0/deploy/uninstall-driver.sh | bash -s v1.36.0 --
```
...
cd azuredisk-csi-driver
git checkout v1.36.0
./deploy/uninstall-driver.sh v1.36.0 local
```
