...
```console
helm install azuredisk-csi-driver azuredisk-csi-driver/azuredisk-csi-driver --namespace kube-system --version v1.30.3
```
...
| `image.csiAttacher.tag`                           | csi-attacher docker image tag                              | `v4.6.1`                                                       |
