...
replace (
	github.com/kata-containers/kata-containers/src/runtime => github.com/microsoft/kata-containers/src/runtime v0.0.0-20260720212037-ddf307a5a057 // tag 3.32.0.kata0
