...
const (
	...
	GroupSnapshotNamespaceTag         = "kubernetes.io-created-for-group-snapshot-namespace"
	GroupSnapshotNameTag              = "kubernetes.io-created-for-group-snapshot-name"
	...
	VolumeGroupSnapshotContentNameKey = "csi.storage.k8s.io/volumegroupsnapshotcontent/name"
