...
func getVolumeAttachment(attachmentName, ns, volumeName, nodeName string) *azdiskv1beta1.AzVolumeAttachment {
	return &azdiskv1beta1.AzVolumeAttachment{
...
func getDriverNode(driverNodeName, ns, nodeName string, ready bool) *azdiskv1beta1.AzDriverNode {
	heartbeat := metav1.Now()
	return &azdiskv1beta1.AzDriverNode{
		ObjectMeta: metav1.ObjectMeta{
			Name:      driverNodeName,
			Namespace: ns,
		},
		...
		Status: &azdiskv1beta1.AzDriverNodeStatus{
