...
var (
	...
	testAzVolumeAttachment = azdiskv1beta1.AzVolumeAttachment{
...
func createAzVolumeAttachmentWithPublishContext(publishContext map[string]string) *azdiskv1beta1.AzVolumeAttachment {
	azVA := testAzVolumeAttachment.DeepCopy()
	azVA.Status = azdiskv1beta1.AzVolumeAttachmentStatus{
