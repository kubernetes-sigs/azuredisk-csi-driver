...
func (o *DriverOptions) AddFlags() *flag.FlagSet {
	...
	fs.Int64Var(&o.VMSSDetachTimeoutInSeconds, "vmss-detach-timeout-seconds", 20, "context timeout for vmss detach operation before polling on VM state to verify detach status")
