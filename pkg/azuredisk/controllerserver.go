...
func (d *Driver) CreateVolume(ctx context.Context, req *csi.CreateVolumeRequest) (*csi.CreateVolumeResponse, error) {
	...
	if diskParams.UserAgent != "" {
		localCloud, err = azureutils.GetCloudProvider(ctx, d.options.KubeConfig, d.options.CloudConfigSecretName, d.options.CloudConfigSecretNamespace, diskParams.UserAgent,
			d.options.AllowEmptyCloudConfig, d.options.EnableTrafficManager, d.options.TrafficManagerPort)
		if err != nil {
...
func (d *Driver) CreateSnapshot(ctx context.Context, req *csi.CreateSnapshotRequest) (*csi.CreateSnapshotResponse, error) {
	...
	for k, v := range parameters {
		...
		case consts.UserAgentField:
			newUserAgent := v
			localCloud, err = azureutils.GetCloudProvider(ctx, d.options.KubeConfig, d.options.CloudConfigSecretName, d.options.CloudConfigSecretNamespace, newUserAgent,
				d.options.AllowEmptyCloudConfig, d.options.EnableTrafficManager, d.options.TrafficManagerPort)
			if err != nil {
