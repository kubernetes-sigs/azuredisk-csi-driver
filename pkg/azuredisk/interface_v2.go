...
type CrdProvisioner interface {
	...
	CreateVolume(ctx context.Context, volumeName string, capacityRange *azdiskv1beta1.CapacityRange,
		volumeCapabilities []azdiskv1beta1.VolumeCapability, parameters map[string]string,
		secrets map[string]string, volumeContentSource *azdiskv1beta1.ContentVolumeSource,
	...
	PublishVolume(ctx context.Context, volumeID string, nodeID string, volumeCapability *azdiskv1beta1.VolumeCapability,
		readOnly bool, secrets map[string]string, volumeContext map[string]string) (map[string]string, error)
	WaitForAttach(ctx context.Context, volume, node string) (*azdiskv1beta1.AzVolumeAttachment, error)
	...
	GetAzVolumeAttachment(ctx context.Context, volumeID string, nodeID string) (*azdiskv1beta1.AzVolumeAttachment, error)
