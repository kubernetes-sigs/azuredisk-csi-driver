...
func TestErrorFromAzError(t *testing.T) {
	...
	tests := []struct {
		description   string
		sourceAzError *azdiskv1beta2.AzError
		expectedError error
	}{
		{
			description: "Dangling attach error",
			sourceAzError: &azdiskv1beta2.AzError{
				Code:    azdiskv1beta2.AzErrorCodeDanglingAttach,
		...
		{
			description:   "GRPC status error",
			sourceAzError: &azdiskv1beta2.AzError{Code: azdiskv1beta2.AzErrorCodeNotFound, Message: "not found"},
