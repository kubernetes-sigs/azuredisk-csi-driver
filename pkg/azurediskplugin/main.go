...
var (
	...
	returnErrorWhenGetZoneFailed = flag.Bool("return-error-when-get-zone-failed", true, "Whether return error when get zone failed in NodeGetInfo")
)
...
func handle() {
	driverOptions := azuredisk.DriverOptions{
		...
		ReturnErrorWhenGetZoneFailed: *returnErrorWhenGetZoneFailed,
	}
