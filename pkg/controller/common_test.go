...
var (
	...
	testAzDriverNode0 = azdiskv1beta1.AzDriverNode{
		ObjectMeta: metav1.ObjectMeta{
			Name:      testNode0Name,
	...
	testAzDriverNode1 = azdiskv1beta1.AzDriverNode{
		ObjectMeta: metav1.ObjectMeta{
			Name:      testNode1Name,
			Namespace: testNamespace,
		},
	...
	testAzDriverNode1NotFoundError = k8serrors.NewNotFound(azdiskv1beta1.Resource("azdrivernodes"), testNode1Name)
	...
	testPrimaryAzVolumeAttachment0 = createTestAzVolumeAttachment(testPersistentVolume0Name, testNode0Name, azdiskv1beta1.PrimaryRole)

	testPrimaryAzVolumeAttachment0Request = createReconcileRequest(testNamespace, testPrimaryAzVolumeAttachment0Name)

	testPrimaryAzVolumeAttachment1 = createTestAzVolumeAttachment(testPersistentVolume1Name, testNode0Name, azdiskv1beta1.PrimaryRole)
	...
	testReplicaAzVolumeAttachment = createTestAzVolumeAttachment(testPersistentVolume0Name, testNode1Name, azdiskv1beta1.ReplicaRole)
...
func createTestAzVolume(pvName string, maxMountReplicaCount int) azdiskv1beta1.AzVolume {
...
func createTestAzVolumeAttachment(pvName, nodeName string, role azdiskv1beta1.Role) azdiskv1beta1.AzVolumeAttachment {
...
func mockClients(mockClient *mockclient.MockClient, azVolumeClient azdisk.Interface, kubeClient kubernetes.Interface) {
	...
	mockClient.EXPECT().
		...
		DoAndReturn(func(ctx context.Context, key types.NamespacedName, obj runtime.Object) error {
			switch target := obj.(type) {
			case *azdiskv1beta1.AzVolume:
				azVolume, err := azVolumeClient.DiskV1beta1().AzVolumes(key.Namespace).Get(ctx, key.Name, metav1.GetOptions{})
				if err != nil {
					return err
				}
	...
	mockClient.EXPECT().
		...
		DoAndReturn(func(ctx context.Context, obj client.Object, patch client.Patch, opts ...client.PatchOptions) error {
			...
			switch target := obj.(type) {
			case *azdiskv1beta1.AzVolume:
				_, err := azVolumeClient.DiskV1beta1().AzVolumes(obj.GetNamespace()).Patch(ctx, obj.GetName(), patch.Type(), data, metav1.PatchOptions{})
				if err != nil {
					return err
				}

			case *azdiskv1beta1.AzVolumeAttachment:
				_, err := azVolumeClient.DiskV1beta1().AzVolumeAttachments(obj.GetNamespace()).Patch(ctx, obj.GetName(), patch.Type(), data, metav1.PatchOptions{})
				if err != nil {
					return err
				}
	...
	mockClient.EXPECT().
		...
		DoAndReturn(func(ctx context.Context, obj client.Object, opts ...client.UpdateOption) error {
			switch target := obj.(type) {
			case *azdiskv1beta1.AzVolume:
				_, err := azVolumeClient.DiskV1beta1().AzVolumes(obj.GetNamespace()).Update(ctx, target, metav1.UpdateOptions{})
				if err != nil {
					return err
				}

			case *azdiskv1beta1.AzVolumeAttachment:
				_, err := azVolumeClient.DiskV1beta1().AzVolumeAttachments(obj.GetNamespace()).Update(ctx, target, metav1.UpdateOptions{})
				if err != nil {
					return err
				}
	...
	mockClient.EXPECT().
		...
		DoAndReturn(func(ctx context.Context, list client.ObjectList, opts ...client.ListOption) error {
			...
			case *azdiskv1beta1.AzVolumeAttachmentList:
				azVolumeAttachments, err := azVolumeClient.DiskV1beta1().AzVolumeAttachments(testNamespace).List(ctx, *options.AsListOptions())
				if err != nil {
					return err
				}

				azVolumeAttachments.DeepCopyInto(target)
			case *azdiskv1beta1.AzDriverNodeList:
				azDriverNodes, err := azVolumeClient.DiskV1beta1().AzDriverNodes(testNamespace).List(ctx, *options.AsListOptions())
				if err != nil {
					return err
				}
