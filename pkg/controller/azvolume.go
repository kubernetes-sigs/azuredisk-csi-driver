...
type VolumeProvisioner interface {
	CreateVolume(
		...
		accessibilityTopology *azdiskv1beta1.TopologyRequirement) (*azdiskv1beta1.AzVolumeStatusDetail, error)
	DeleteVolume(ctx context.Context, volumeID string, secrets map[string]string) error
	ExpandVolume(ctx context.Context, volumeID string, capacityRange *azdiskv1beta1.CapacityRange, secrets map[string]string) (*azdiskv1beta1.AzVolumeStatusDetail, error)
}
...
var allowedTargetVolumeStates = map[string][]string{
	"": {string(azdiskv1beta1.VolumeOperationPending), string(azdiskv1beta1.VolumeCreating), string(azdiskv1beta1.VolumeDeleting)},
	string(azdiskv1beta1.VolumeOperationPending): {string(azdiskv1beta1.VolumeCreating), string(azdiskv1beta1.VolumeDeleting)},
	string(azdiskv1beta1.VolumeCreating):         {string(azdiskv1beta1.VolumeCreated), string(azdiskv1beta1.VolumeCreationFailed)},
	string(azdiskv1beta1.VolumeDeleting):         {string(azdiskv1beta1.VolumeDeleted), string(azdiskv1beta1.VolumeDeletionFailed)},
	string(azdiskv1beta1.VolumeUpdating):         {string(azdiskv1beta1.VolumeUpdated), string(azdiskv1beta1.VolumeUpdateFailed)},
	string(azdiskv1beta1.VolumeCreated):          {string(azdiskv1beta1.VolumeUpdating), string(azdiskv1beta1.VolumeDeleting)},
	string(azdiskv1beta1.VolumeDeleted):          {},
	string(azdiskv1beta1.VolumeUpdated):          {string(azdiskv1beta1.VolumeUpdating), string(azdiskv1beta1.VolumeDeleting)},
	string(azdiskv1beta1.VolumeCreationFailed):   {},
	string(azdiskv1beta1.VolumeDeletionFailed):   {},
}
...
func (r *ReconcileAzVolume) triggerCreate(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) error {
	var err error
	...
	updateFunc := func(obj interface{}) error {
		...
		_, err := r.updateState(azv, azdiskv1beta1.VolumeCreating, normalUpdate)
		return err
	}
	...
	go func() {
		...
		var response *azdiskv1beta1.AzVolumeStatusDetail
		...
		if createErr != nil {
			updateFunc = func(obj interface{}) error {
				...
				_, derr := r.updateState(azv, azdiskv1beta1.VolumeCreationFailed, forceUpdate)
				return derr
			}
			...
			updateFunc = func(obj interface{}) error {
				...
				_, derr := r.updateState(azv, azdiskv1beta1.VolumeCreated, forceUpdate)
				return derr
			}
		}
...
func (r *ReconcileAzVolume) triggerDelete(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) error {
	var err error
	ctx, w := workflow.New(ctx)
	defer func() { w.Finish(err) }()
	...
	if isCreated(azVolume) && mode == detachAndDeleteCRI {
		...
		updateFunc := func(obj interface{}) error {
			azv := obj.(*azdiskv1beta1.AzVolume)
			_, derr := r.updateState(azv, azdiskv1beta1.VolumeDeleting, normalUpdate)
			return derr
		}
		...
		go func() {
			...
			reportError := func(obj interface{}, err error) error {
				...
				_, derr := r.updateState(azv, azdiskv1beta1.VolumeDeletionFailed, forceUpdate)
				return derr
			}
			...
			if err == nil {
				...
				if deleteErr != nil {
					...
					updateFunc = func(obj interface{}) error {
						...
						var derr error
						if volumeDeleteRequested {
							_, derr = r.updateState(azv, azdiskv1beta1.VolumeDeleted, forceUpdate)
						}
						return derr
					}
				}
...
func (r *ReconcileAzVolume) triggerUpdate(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) error {
	var err error
	ctx, w := workflow.New(ctx)
	defer func() { w.Finish(err) }()
	...
	updateFunc := func(obj interface{}) error {
		azv := obj.(*azdiskv1beta1.AzVolume)
		_, derr := r.updateState(azv, azdiskv1beta1.VolumeUpdating, normalUpdate)
		return derr
	}
	if err = azureutils.UpdateCRIWithRetry(ctx, nil, r.controllerSharedState.cachedClient, r.controllerSharedState.azClient, azVolume, updateFunc, consts.NormalUpdateMaxNetRetry, azureutils.UpdateCRIStatus); err != nil {
		return err
	...
	go func() {
		...
		if updateErr != nil {
			updateFunc = func(obj interface{}) error {
				...
				_, derr := r.updateState(azv, azdiskv1beta1.VolumeUpdateFailed, forceUpdate)
				return derr
			}
		} else {
			updateFunc = func(obj interface{}) error {
				...
				azv = r.updateStatusDetail(azv, response, response.CapacityBytes, response.NodeExpansionRequired)
				_, derr := r.updateState(azv, azdiskv1beta1.VolumeUpdated, forceUpdate)
				return derr
			}
		}
...
func (r *ReconcileAzVolume) deleteFinalizer(azVolume *azdiskv1beta1.AzVolume, finalizersToDelete map[string]bool) *azdiskv1beta1.AzVolume {
	if azVolume == nil {
		return nil
	}
...
func (r *ReconcileAzVolume) updateState(azVolume *azdiskv1beta1.AzVolume, state azdiskv1beta1.AzVolumeState, mode updateMode) (*azdiskv1beta1.AzVolume, error) {
	var err error
	if azVolume == nil {
...
func (r *ReconcileAzVolume) updateStatusDetail(azVolume *azdiskv1beta1.AzVolume, status *azdiskv1beta1.AzVolumeStatusDetail, capacityBytes int64, nodeExpansionRequired bool) *azdiskv1beta1.AzVolume {
	if azVolume == nil {
		return nil
	}
...
func (r *ReconcileAzVolume) updateError(azVolume *azdiskv1beta1.AzVolume, err error) *azdiskv1beta1.AzVolume {
	if azVolume == nil {
		return nil
	}
...
func (r *ReconcileAzVolume) expandVolume(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) (*azdiskv1beta1.AzVolumeStatusDetail, error) {
	if azVolume.Status.Detail == nil {
...
func (r *ReconcileAzVolume) createVolume(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) (*azdiskv1beta1.AzVolumeStatusDetail, error) {
	if azVolume.Status.Detail != nil {
...
func (r *ReconcileAzVolume) deleteVolume(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) error {
	if azVolume.Status.Detail == nil {
		return nil
	}
	// use deep-copied version of the azVolume CRI to prevent any unwanted update to the object
...
func (r *ReconcileAzVolume) recoverAzVolume(ctx context.Context, recoveredAzVolumes *sync.Map) error {
	...
	for _, azVolume := range azVolumes.Items {
		...
		wg.Add(1)
		go func(azv azdiskv1beta1.AzVolume, azvMap *sync.Map) {
			defer wg.Done()
			var targetState azdiskv1beta1.AzVolumeState
			updateFunc := func(obj interface{}) error {
				var err error
				azv := obj.(*azdiskv1beta1.AzVolume)
			...
			case azdiskv1beta1.VolumeCreating:
				// reset state to Pending so Create operation can be redone
				targetState = azdiskv1beta1.VolumeOperationPending
			case azdiskv1beta1.VolumeDeleting:
				// reset state to Created so Delete operation can be redone
				targetState = azdiskv1beta1.VolumeCreated
...
func NewAzVolumeController(mgr manager.Manager, volumeProvisioner VolumeProvisioner, controllerSharedState *SharedState) (*ReconcileAzVolume, error) {
	...
	err = c.Watch(&source.Kind{Type: &azdiskv1beta1.AzVolume{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
...
func (c *SharedState) createAzVolumeFromPv(ctx context.Context, pv v1.PersistentVolume, annotations map[string]string) error {
	...
	if azVolume != nil {
		...
		azVolume.Spec.CapacityRange = &azdiskv1beta1.CapacityRange{RequiredBytes: requiredBytes}
...
func (c *SharedState) createAzVolumeFromCSISource(source *v1.CSIPersistentVolumeSource) (*azdiskv1beta1.AzVolume, error) {
	...
	azVolume := azdiskv1beta1.AzVolume{
		...
		Status: azdiskv1beta1.AzVolumeStatus{
			Detail: &azdiskv1beta1.AzVolumeStatusDetail{
...
func (c *SharedState) createAzVolumeFromAzureDiskVolumeSource(source *v1.AzureDiskVolumeSource) *azdiskv1beta1.AzVolume {
	azVolume := azdiskv1beta1.AzVolume{
		ObjectMeta: metav1.ObjectMeta{
...
func (c *SharedState) createAzVolume(ctx context.Context, azVolume *azdiskv1beta1.AzVolume) error {
	var updated *azdiskv1beta1.AzVolume
	var err error
...
func getVolumeCapabilityFromPv(pv *v1.PersistentVolume) []azdiskv1beta1.VolumeCapability {
	...
	for _, accessMode := range pv.Spec.AccessModes {
		...
		case v1.ReadWriteOnce:
			volCap.AccessMode = azdiskv1beta1.VolumeCapabilityAccessModeSingleNodeSingleWriter
		case v1.ReadWriteMany:
			volCap.AccessMode = azdiskv1beta1.VolumeCapabilityAccessModeMultiNodeMultiWriter
		case v1.ReadOnlyMany:
			volCap.AccessMode = azdiskv1beta1.VolumeCapabilityAccessModeMultiNodeReaderOnly
		default:
			volCap.AccessMode = azdiskv1beta1.VolumeCapabilityAccessModeUnknown
		}
