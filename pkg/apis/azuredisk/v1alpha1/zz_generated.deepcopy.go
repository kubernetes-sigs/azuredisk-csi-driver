...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AzVolumeError) DeepCopyInto(out *AzVolumeError) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzVolumeError.
func (in *AzVolumeError) DeepCopy() *AzVolumeError {
	if in == nil {
		return nil
	}
	out := new(AzVolumeError)
