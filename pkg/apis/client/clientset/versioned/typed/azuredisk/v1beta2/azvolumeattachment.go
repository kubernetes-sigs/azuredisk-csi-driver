...
type AzVolumeAttachmentInterface interface {
	Create(ctx context.Context, azVolumeAttachment *v1beta2.AzVolumeAttachment, opts v1.CreateOptions) (*v1beta2.AzVolumeAttachment, error)
	Update(ctx context.Context, azVolumeAttachment *v1beta2.AzVolumeAttachment, opts v1.UpdateOptions) (*v1beta2.AzVolumeAttachment, error)
	UpdateStatus(ctx context.Context, azVolumeAttachment *v1beta2.AzVolumeAttachment, opts v1.UpdateOptions) (*v1beta2.AzVolumeAttachment, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta2.AzVolumeAttachment, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta2.AzVolumeAttachmentList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.AzVolumeAttachment, err error)
...
func newAzVolumeAttachments(c *DiskV1beta2Client, namespace string) *azVolumeAttachments {
...
func (c *azVolumeAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta2.AzVolumeAttachment, err error) {
	result = &v1beta2.AzVolumeAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *azVolumeAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1beta2.AzVolumeAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.AzVolumeAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("azvolumeattachments").
...
func (c *azVolumeAttachments) Create(ctx context.Context, azVolumeAttachment *v1beta2.AzVolumeAttachment, opts v1.CreateOptions) (result *v1beta2.AzVolumeAttachment, err error) {
	result = &v1beta2.AzVolumeAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("azvolumeattachments").
...
func (c *azVolumeAttachments) Update(ctx context.Context, azVolumeAttachment *v1beta2.AzVolumeAttachment, opts v1.UpdateOptions) (result *v1beta2.AzVolumeAttachment, err error) {
	result = &v1beta2.AzVolumeAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azvolumeattachments").
...
func (c *azVolumeAttachments) UpdateStatus(ctx context.Context, azVolumeAttachment *v1beta2.AzVolumeAttachment, opts v1.UpdateOptions) (result *v1beta2.AzVolumeAttachment, err error) {
	result = &v1beta2.AzVolumeAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("azvolumeattachments").
...
func (c *azVolumeAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta2.AzVolumeAttachment, err error) {
	result = &v1beta2.AzVolumeAttachment{}
