...
func (c *FakeAzDriverNodes) UpdateStatus(ctx context.Context, azDriverNode *v1beta1.AzDriverNode, opts v1.UpdateOptions) (*v1beta1.AzDriverNode, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(azdrivernodesResource, "status", c.ns, azDriverNode), &v1beta1.AzDriverNode{})
...
func (c *FakeAzDriverNodes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(azdrivernodesResource, c.ns, name, opts), &v1beta1.AzDriverNode{})
