...
type AzVolumeAttachmentInformer interface {
	...
	Lister() v1beta2.AzVolumeAttachmentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DiskV1beta2().AzVolumeAttachments(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DiskV1beta2().AzVolumeAttachments(namespace).Watch(context.TODO(), options)
			},
		},
		&azurediskv1beta2.AzVolumeAttachment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *azVolumeAttachmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurediskv1beta2.AzVolumeAttachment{}, f.defaultInformer)
}

func (f *azVolumeAttachmentInformer) Lister() v1beta2.AzVolumeAttachmentLister {
	return v1beta2.NewAzVolumeAttachmentLister(f.Informer().GetIndexer())
}
