...
type AzVolumeInformer interface {
	...
	Lister() v1alpha1.AzVolumeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DiskV1alpha1().AzVolumes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DiskV1alpha1().AzVolumes(namespace).Watch(context.TODO(), options)
			},
		},
		&azurediskv1alpha1.AzVolume{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *azVolumeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&azurediskv1alpha1.AzVolume{}, f.defaultInformer)
}

func (f *azVolumeInformer) Lister() v1alpha1.AzVolumeLister {
	return v1alpha1.NewAzVolumeLister(f.Informer().GetIndexer())
}
