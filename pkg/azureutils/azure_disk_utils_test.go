...
func TestParseDiskParameters(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expectedError: fmt.Errorf("parse diskIOPSReadWrite failed with error: strconv.Atoi: parsing \"diskIOPSReadWrite\": invalid syntax"),
		},
		{
			...
			expectedError: fmt.Errorf("parse diskMBPSReadWrite failed with error: strconv.Atoi: parsing \"diskMBPSReadWrite\": invalid syntax"),
		},
		{
