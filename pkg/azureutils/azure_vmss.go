...
func (ss *ScaleSet) GetInstanceIDByNodeName(name string) (string, error) { return "", nil }

// GetInstanceTypeByNodeName gets the instance type by node name.
func (ss *ScaleSet) GetInstanceTypeByNodeName(name string) (string, error) { return "", nil }

// GetIPByNodeName gets machine private IP and public IP by node name.
func (ss *ScaleSet) GetIPByNodeName(name string) (string, string, error) { return "", "", nil }
...
func (ss *ScaleSet) GetPrimaryVMSetName() string { return "" }
...
func (ss *ScaleSet) GetNodeVMSetName(node *v1.Node) (string, error) { return "", nil }
...
func (ss *ScaleSet) UpdateVM(ctx context.Context, nodeName types.NodeName) error { return nil }
...
func (ss *ScaleSet) GetPowerStatusByNodeName(name string) (string, error) { return "", nil }
...
func (ss *ScaleSet) GetPrivateIPsByNodeName(name string) ([]string, error) { return nil, nil }
...
func (ss *ScaleSet) DeleteCacheForNode(nodeName string) error { return nil }
