...
func IsMultiNodeAzVolumeCapabilityAccessMode(accessMode azdiskv1beta1.VolumeCapabilityAccessMode) bool {
	return accessMode == azdiskv1beta1.VolumeCapabilityAccessModeMultiNodeMultiWriter ||
		accessMode == azdiskv1beta1.VolumeCapabilityAccessModeMultiNodeSingleWriter ||
		accessMode == azdiskv1beta1.VolumeCapabilityAccessModeMultiNodeReaderOnly
}

func HasMultiNodeAzVolumeCapabilityAccessMode(volCaps []azdiskv1beta1.VolumeCapability) bool {
...
func GetAzVolumePhase(phase v1.PersistentVolumePhase) azdiskv1beta1.AzVolumePhase {
	return azdiskv1beta1.AzVolumePhase(phase)
}

func GetAzVolume(ctx context.Context, cachedClient client.Client, azDiskClient azdisk.Interface, azVolumeName, namespace string, useCache bool) (*azdiskv1beta1.AzVolume, error) {
...
func ListAzVolumes(ctx context.Context, cachedClient client.Client, azDiskClient azdisk.Interface, namespace string, useCache bool) (azdiskv1beta1.AzVolumeList, error) {
	var azVolumeList *azdiskv1beta1.AzVolumeList
	var err error
	if useCache {
		azVolumeList = &azdiskv1beta1.AzVolumeList{}
...
func GetAzVolumeAttachment(ctx context.Context, cachedClient client.Client, azDiskClient azdisk.Interface, azVolumeAttachmentName, namespace string, useCache bool) (*azdiskv1beta1.AzVolumeAttachment, error) {
...
func ListAzVolumeAttachments(ctx context.Context, cachedClient client.Client, azDiskClient azdisk.Interface, namespace string, useCache bool) (azdiskv1beta1.AzVolumeAttachmentList, error) {
	var azVolumeAttachmentList *azdiskv1beta1.AzVolumeAttachmentList
	var err error
	if useCache {
		azVolumeAttachmentList = &azdiskv1beta1.AzVolumeAttachmentList{}
...
func GetAzVolumeAttachmentState(volumeAttachmentStatus storagev1.VolumeAttachmentStatus) azdiskv1beta1.AzVolumeAttachmentAttachmentState {
	if volumeAttachmentStatus.Attached {
		return azdiskv1beta1.Attached
	} else if volumeAttachmentStatus.AttachError != nil {
		return azdiskv1beta1.AttachmentFailed
	} else if volumeAttachmentStatus.DetachError != nil {
		return azdiskv1beta1.DetachmentFailed
	} else {
		return azdiskv1beta1.AttachmentPending
	}
}
...
func UpdateCRIWithRetry(ctx context.Context, informerFactory azdiskinformers.SharedInformerFactory, cachedClient client.Client, azDiskClient azdisk.Interface, obj client.Object, updateFunc func(interface{}) error, maxNetRetry int, updateMode CRIUpdateMode) error {
	...
	conditionFunc := func() error {
		...
		case *azdiskv1beta1.AzVolume:
			updateTarget := &azdiskv1beta1.AzVolume{}
		...
		case *azdiskv1beta1.AzVolumeAttachment:
			updateTarget := &azdiskv1beta1.AzVolumeAttachment{}
			if informerFactory != nil {
		...
		case *azdiskv1beta1.AzVolume:
			if (updateMode&UpdateCRIStatus) != 0 && !reflect.DeepEqual(objForUpdate.(*azdiskv1beta1.AzVolume).Status, target.Status) {
		...
		case *azdiskv1beta1.AzVolumeAttachment:
			if (updateMode&UpdateCRIStatus) != 0 && !reflect.DeepEqual(objForUpdate.(*azdiskv1beta1.AzVolumeAttachment).Status, target.Status) {
