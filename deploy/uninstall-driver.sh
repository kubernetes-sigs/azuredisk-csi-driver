...
if [[ $ver == "v2"* ]]; then
  kubectl delete -f $repo/csi-azuredisk-scheduler-extender.yaml
  kubectl delete -f $repo/rbac-csi-azuredisk-scheduler-extender.yaml
  kubectl delete -f $repo/namespace-azure-disk-csi.yaml
  kubectl delete -f $repo/disk.csi.azure.com_azdrivernodes.yaml
  kubectl delete -f $repo/disk.csi.azure.com_azvolumeattachments.yaml
  kubectl delete -f $repo/disk.csi.azure.com_azvolumes.yaml
fi
