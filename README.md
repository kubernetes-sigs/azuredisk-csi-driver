...
|v1.27.0         |mcr.microsoft.com/oss/kubernetes-csi/azuredisk-csi:v1.27.0 | 1.21+                 |
...
|----------------|-----------------------------------------------------------------|-----------------------|
|`main_v2` branch|                                                                 | 1.21+                 |
|v2.0.0-beta.10   |mcr.microsoft.com/oss/kubernetes-csi/azuredisk-csi:v2.0.0-beta.10 | 1.21+                 |
